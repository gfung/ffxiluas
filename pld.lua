...
function get_sets()
    ...
    sets.midcast.WS = {
        head={name="Flam. Zucchetto +2",hp=80, mp=20},
        neck="Fotia Gorget",
        ear1="Moonshade Earring",
        ear2="Brutal Earring",
        body={name="Flamma Korazin +1",hp=140, mp=35},
        ...
        waist="Fotia Belt",
        legs={ name="Valor. Hose", augments={'Accuracy+27','Crit. hit damage +5%','DEX+3',}, hp=95},
        feet={name="Flam. Gambieras +2",hp=40,mp=10},
        }
    ...
    sets.aftercast.DW = {
        ...
        -- sub="Malignance Sword",
        head="Flam. Zucchetto +2",
        body={ name="Valorous Mail", augments={'"Dbl.Atk."+5','Attack+11',}},
        ...
        right_ring="Flamma Ring",
        back={ name="Rudianos's Mantle", augments={'HP+60','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},
    }
